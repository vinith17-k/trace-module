  ...
  public: {
    ...
    Enums: {
      action_type:
        ...
        | "none";
      app_role:
        "counsellor" | "law_enforcement" | "admin" | "district_officer" | "welfare_authority";
      channel_type: "voice" | "chatbot" | "ivrs" | "webform" | "app";
      priority_level: "routine" | "urgent" | "immediate";
      recommendation_status: "pending" | "dispatched" | "acknowledged" | "resolved";
...
export const Constants = {
  public: {
    Enums: {
      ...
      app_role: ["counsellor", "law_enforcement", "admin", "district_officer", "welfare_authority"],
      channel_type: ["voice", "chatbot", "ivrs", "webform", "app"],
      priority_level: ["routine", "urgent", "immediate"],
      recommendation_status: ["pending", "dispatched", "acknowledged", "resolved"],
      risk_category: ["low", "moderate", "high", "critical"],
