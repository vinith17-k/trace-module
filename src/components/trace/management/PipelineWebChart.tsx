...
const INITIAL_NODES: WebChartNode[] = [
  // Layer 1: Ingress
  {
    ...
    capacity: 500,
    description:
      "Direct bi-directional mesh sync for 180 Gram Panchayat touch-kiosks with offline token storage.",
    comments: [
      {
        id: "c1",
        author: "Sunil Nair",
  ...
  },
  {
    ...
    capacity: 600,
    description:
      "Multi-lingual toll-free helpline supporting 9 regional dialects with real-time whisper transcription.",
    comments: [
      {
        id: "c2",
        author: "DySP K. Meena",
  ...
  },
  {
    ...
    capacity: 2000,
    description:
      "End-to-end encrypted mobile client with disguised icon mode and tamper-evident local audit log.",
    comments: [],
  },
  ...
  // Layer 2: AI Core
  {
    ...
    capacity: 200,
    description:
      "Fine-tuned acoustic model resolving caste slurs, colloquial coercion markers, and regional audio cues.",
    comments: [
      {
        id: "c3",
  ...
  },
  {
    ...
    capacity: 350,
    description:
      "14-factor weighted statutory risk matrix scoring physical danger, social boycott, and economic blockade.",
    comments: [],
  },
  {
    id: "node-ai-3",
    ...
    capacity: 220,
    description:
      "Zero-knowledge scrubber eliminating witness names, hamlet landmarks, and Aadhaar numbers prior to cloud relay.",
    comments: [
      {
        id: "c4",
        author: "Adv. S. Raman",
  ...
  // Layer 3: Dispatch Router
  {
    ...
    capacity: 80,
    description:
      "Statutory First Response Officers mandated under Section 15A of POA Act for immediate physical security.",
    comments: [
      {
        id: "c5",
  ...
  },
  {
    ...
    capacity: 40,
    description:
      "Armed escort vehicles with GPS telemetry dispatched for red-tier critical threats.",
    comments: [],
  },
  {
    id: "node-disp-3",
    ...
    capacity: 50,
    description:
      "Panel advocate roster assigning state-funded legal defense within 24 hours of FIR registration.",
    comments: [
      {
        id: "c6",
        author: "Adv. T. Murthy",
  ...
  // Layer 4: Relief & Justice
  {
    ...
    capacity: 100,
    description:
      "Mandatory 25% interim compensation disbursed directly to DBT bank accounts under SC/ST Rules.",
    comments: [
      {
        id: "c7",
        author: "DM K. S. Rao",
  ...
  },
  {
    ...
    capacity: 30,
    description:
      "Secure temporary transit accommodation and psychological trauma counselling for displaced victims.",
    comments: [],
  },
  {
    id: "node-rel-3",
    ...
    capacity: 90,
    description:
      "Designated Special Court under Section 14 POA Act for trial completion within 60 days.",
    comments: [
      {
        id: "c8",
...
const LAYER_CONFIG = {
  ingress: {
    title: "1. Ingress & Telemetry",
    color: "#5B8DEF",
    desc: "Field touchpoints & distress ingestion",
  },
  ai_core: {
    title: "2. SVI AI Core & Triage",
    color: "#B688F7",
    desc: "Transcription, scoring & de-identification",
  },
  dispatch: {
    title: "3. Statutory Dispatch",
    color: "#E0A23D",
    desc: "Police escort & legal counsel routing",
  },
  relief: {
    title: "4. Inter-Agency Relief",
    color: "#6FA287",
    desc: "DBT compensation & Special Courts",
  },
};
...
export const PipelineWebChart: React.FC<PipelineWebChartProps> = ({ onNotify }) => {
  ...
  // Form states
  const selectedNode: WebChartNode =
    nodes.find((n) => n.id === selectedNodeId) || nodes[0] || (INITIAL_NODES[0] as WebChartNode);
  ...
  const handleSaveEdit = (e: React.FormEvent) => {
    e.preventDefault();
    setNodes((prev) =>
      prev.map((n) => (n.id === editFormData.id ? { ...editFormData, comments: n.comments } : n)),
    );
    setIsEditing(false);
  ...
  const filteredNodes = nodes.filter((node) => {
    ...
    const matchesAgency =
      filterAgency === "all" || node.agency.toLowerCase().includes(filterAgency.toLowerCase());
                      ...
                      return (
                        ...
                        >
                          ...
                          <div style={{ margin: "8px 0 6px" }}>
                            ...
                            >
                              <span>
                                Load: {node.activeLoad}/{node.capacity}
                              </span>
                              <span
                                style={{ color: loadPct > 80 ? "var(--a-critical)" : "inherit" }}
                              >
                    ...
                    selectedNode.comments.map((c) => (
                      ...
                      >
                        ...
                        >
                          ...
                          <span style={{ fontSize: 10.5, color: "var(--a-muted)" }}>
                            {c.timestamp}
                          </span>
                        </div>
                        <p
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    borderColor: "rgba(224,88,79,0.3)",
                    fontSize: 11.5,
                    padding: "4px 10px",
                    display: "inline-flex",
                    alignItems: "center",
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setEditFormData({
                        ...editFormData,
                        layer: e.target.value as WebChartNode["layer"],
                      })
                    }
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setEditFormData({
                        ...editFormData,
                        status: e.target.value as WebChartNode["status"],
                      })
                    }
                  >
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditFormData({ ...editFormData, leadOfficer: e.target.value })
                    }
                    required
                  />
                </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditFormData({
                        ...editFormData,
                        activeLoad: parseInt(e.target.value) || 0,
                      })
                    }
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditFormData({ ...editFormData, capacity: parseInt(e.target.value) || 1 })
                    }
                  />
                </div>
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewNodeData({ ...newNodeData, leadOfficer: e.target.value })
                    }
                    required
                  />
                </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewNodeData({ ...newNodeData, capacity: parseInt(e.target.value) || 20 })
                    }
                  />
                </div>
              </div>
