...
export const CollaborativeNotesFeed: React.FC<CollaborativeNotesFeedProps> = ({ onNotify }) => {
  ...
  const handleTogglePin = (directiveId: string) => {
    setDirectives((prev) =>
      prev.map((d) => (d.id === directiveId ? { ...d, isPinned: !d.isPinned } : d)),
    );
  };
    ...
    switch (category) {
      ...
      case "coordination":
        return (
          <span
            className="badge"
            style={{ background: "rgba(91,141,239,0.15)", color: "var(--a-accent)", fontSize: 10 }}
          >
            Inter-Agency
          </span>
        );
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span style={{ fontWeight: 700, fontSize: 14 }}>
              Inter-Agency Directives & Direct Orders
            </span>
            <span
              className="badge"
              style={{
          ...
          {filteredDirectives.map((directive) => {
            ...
            return (
              <div
                ...
                style={{
                  borderLeft: directive.isPinned
                    ? "3px solid var(--a-critical)"
              ...
              >
                <div className="comment-header">
                  <div className="comment-author">
                    ...
                    <div>
                      ...
                      >
                        <Building2 size={11} /> {directive.agency} •{" "}
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap" }}>
                    ...
                    >
                      <CheckCheck size={13} color="#6FA287" /> Acknowledged by (
                      {directive.acknowledgedBy.length}):
                    </span>
          ...
          >
            <div>
              ...
              <select
                className="search-box"
                value={newAgencyType}
                onChange={(e) => setNewAgencyType(e.target.value as DirectiveComment["agencyType"])}
              >
            ...
            <div>
              ...
              <select
                className="search-box"
                value={newCategory}
                onChange={(e) => setNewCategory(e.target.value as DirectiveComment["category"])}
              >
