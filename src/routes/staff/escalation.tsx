...
function EscalationCenterPage() {
  ...
  const [notifications, setNotifications] = useState<NotificationItem[]>([
    ...
    { id: '3', target: 'NHAA-9A73-L02 → Counselling Network', priority: 'Routine', status: 'pending' },
    { id: '4', target: 'NHAA-7E55-Q19 → Medical Assistance', priority: 'Routine', status: 'failed' },
  ]);
  ...
  return (
    <StaffLayout mode="staff">
      ...
      <p className="inline-legend" style={{ margin: '0 0 16px', display: 'inline-block' }}>
        Badge color here reflects <b style={{ color: 'var(--a-text)' }}>delivery status</b>, not case risk tier — a failed send is always shown in red regardless of the case's own priority.
      </p>
